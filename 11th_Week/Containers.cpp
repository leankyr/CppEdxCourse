...
int main() {
	...
	//Intersection
  // tjhe only common values are 1, 2, 3 so this what we get on intersection
  ...
  // you get zeros when there is no intersection in the containers 
	...
	cout << endl;
  // accumulate by defauult adds the values (1 + 2 + 3 + ... + 9 + 10 = 55. 55 + 100 = 155) 
